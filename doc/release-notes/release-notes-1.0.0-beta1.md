...
Lars-Magnus Skog (1):
      changed module name from "bitcoin" to "Crypticcoin" in FormatException()
...
Simon (91):
      ...
      Reduce use of global pcrypticcoinParams with private member variable
      Revert "Reduce use of global pcrypticcoinParams with private member variable"
      Replace crypticcoinParams_ with global.
