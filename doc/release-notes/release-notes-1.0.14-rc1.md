...
Jack Grigg (36):
      ...
      build: Split hardening/fPIE options out in Crypticcoin-specific binaries
      Change --enable-werror to apply to all warnings, use it in build.sh
      Move Crypticcoin flags into configure.ac
      ViewingKey -> ReceivingKey per crypticcoin/zips#117
      ...
      Add watch-only support to Crypticcoin RPC methods
...
syd (13):
      ...
      Rename bash completion files so that they refer to crypticcoin and not bitcoin.
