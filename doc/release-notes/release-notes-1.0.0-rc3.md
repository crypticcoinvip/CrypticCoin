...
Daira Hopwood (9):
      ...
      Tweak descriptions of mining parameters for example crypticcoin.conf.
...
Sean Bowe (1):
      Add manpages for crypticcoind and crypticcoin-cli binaries for debian.
