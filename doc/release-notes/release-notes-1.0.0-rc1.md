...
Jay Graber (17):
      ...
      Refer to Crypticcoin wiki in INSTALL
      Rm bitcoin logo
      Rm build-unix.md, to keep single copy of build instructions for Crypticcoin on github wiki
      Rm Bitcoin-specific documentation
      Add note that document is not updated for Crypticcoin to translation policy
      Rm doc for disabled REST interface
      Change alpha to beta testnet, add crypticcoin hidden service
      Improve documentation on connecting to crypticcoin hidden server
      Improve documentation on connecting to crypticcoin hidden server
      Update tor.md
...
Simon (11):
      ...
      Reorder gtests in crypticcoin-gtest.
