...
Jack Grigg (33):
      ...
      Migrate Crypticcoin-specific code to UniValue
      ...
      Update UniValue includes in Crypticcoin-specific code
      UniValue::getValues const reference
      Get rid of fPlus argument to FormatMoney in Crypticcoin-specific code
