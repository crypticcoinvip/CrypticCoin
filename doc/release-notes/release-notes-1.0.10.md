...
ECDSA signatures inside Crypticcoin transactions now use validation using
...
Daira Hopwood (8):
      ...
      Delete test that is redundant and inapplicable to Crypticcoin.
...
Jack Grigg (20):
      ...
      Hold an ECCVerifyHandle in crypticcoin-gtest
