...
Jack Grigg (31):
      ...
      Rename libbitcoinconsensus to libcrypticcoinconsensus
      Rename bitcoin-tx to crypticcoin-tx
...
Jay Graber (7):
      Rm bitcoin dev keys from gitian-downloader, add crypticcoin dev keys
      Rm bips.md
      Update files.md for crypticcoin
