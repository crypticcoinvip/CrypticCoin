...
usage () {
	echo "USAGE: build-CrypticCoin.sh [-v version] [-s SIGNER] [-d true/false]"
	echo "Where v(ersion) should be the next version of the wallet"
	echo "Where s(igner) is used for the gitian signature, for example user@CrypticCoin.io - no signer will skip signatures"
...
bin/gbuild ../CrypticCoin/contrib/gitian-descriptors/boost-linux.yml
mv build/out/boost-*.zip inputs/

bin/gbuild ../CrypticCoin/contrib/gitian-descriptors/deps-linux.yml
mv build/out/CrypticCoin-deps-*.zip inputs/

bin/gbuild ../CrypticCoin/contrib/gitian-descriptors/qt-linux.yml
mv build/out/qt-*.tar.gz inputs/

bin/gbuild ../CrypticCoin/contrib/gitian-descriptors/boost-win.yml
mv build/out/boost-*.zip inputs/

bin/gbuild ../CrypticCoin/contrib/gitian-descriptors/deps-win.yml
mv build/out/CrypticCoin-deps-*.zip inputs/

bin/gbuild ../CrypticCoin/contrib/gitian-descriptors/qt-win.yml
mv build/out/qt-*.zip inputs/

bin/gbuild ../CrypticCoin/contrib/gitian-descriptors/protobuf-win.yml
...
bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../CrypticCoin/contrib/gitian-descriptors/gitian-linux.yml
bin/gbuild --commit CrypticCoin=v${VERSION} ../CrypticCoin/contrib/gitian-descriptors/gitian-win.yml
bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../CrypticCoin/contrib/gitian-descriptors/gitian-win.yml
