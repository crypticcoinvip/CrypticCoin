...
Intro
-----
CrypticCoin is a free open source project derived from PPCoin, with
...
After completing windows setup then run windows command line (cmd)
  cd daemon
  CrypticCoind
You would need to create a configuration file CrypticCoin.conf in the default
wallet directory. Grant access to CrypticCoind.exe in anti-virus and firewall
...
CrypticCoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
CrypticCoind stop
Start up the new CrypticCoind (0.2.0).
