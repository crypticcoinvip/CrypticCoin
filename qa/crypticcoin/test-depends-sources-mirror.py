...
# contains all of the packages required to build this version of Crypticcoin.
#
# This script assumes you've just built Crypticcoin, and that as a result of that
