...
class NUPeerManagementTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Connect a new Sapling mininode to the crypticcoind node, which is accepted.
        ...
        # Try to connect a new Overwinter mininode to the crypticcoind node, which is rejected.
