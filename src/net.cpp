...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CrypticCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadOnionSeed(void* parg)
{
    ...
    RenameThread("CrypticCoin-onionseed");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("CrypticCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("CrypticCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CrypticCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("CrypticCoin-adrdump");
...
void StartNode(void* threadGroup)
{
    RenameThread("CrypticCoin-start");
