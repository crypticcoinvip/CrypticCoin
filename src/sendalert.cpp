...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client version 1.0.10 has degraded networking behavior. Please update to the most recent version of CrypticCoin (1.0.10-1 or later).";
