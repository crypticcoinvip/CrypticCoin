...
public:
     ...
     * the coins were to be wiped out by FromTx anyway. We rely on Crypticcoin-derived block chains
     * having no duplicate transactions, since BIP 30 and (except for the genesis block)
     * BIP 34 have been enforced since launch. See the Crypticcoin protocol specification, section
