...
static const int64 YEAR_BLOCKS[] = { 20, 50, 70, 100, 120, 140, 1048320, 2096640, 3144960, 4193280, 5241600, 6289920 }; // Number of block which will be mined in one year, two, three and etc.
