...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "crypticcoin.conf"));
...
std::string LicenseInfo()
{
    return "\n" +
           ...
           FormatParagraph(strprintf(_("Copyright (C) 2018-%i The Crypticcoin Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
